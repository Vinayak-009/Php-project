...
<?php 
                ...
                ?>
                    ...
                    <td> <?php echo  "<a  href ='update.php?rn=$row[roll_number]&fn=$row[name]&em=$row[email]&pn=$row[phone_number]&ut=$row[user_type]'>Edit/Update "  ?></td>
                    <td><?php echo "<a  href ='delete.php?rn=$row[roll_number]' onclick='return checkdelete()'>Delete" ?> </td>
